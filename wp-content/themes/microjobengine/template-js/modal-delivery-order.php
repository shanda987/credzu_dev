...
<!--                        <div id="gallery_container" class="image-upload attachment-file gallery_container" style="margin-bottom: 30px;">-->
<!--                            <div  class="browse_button carousel_container">-->
<!--                                <ul class="gallery-image carousel-list requirement-image-list image-list" id="image-list">-->
<!---->
<!--                                </ul>-->
<!--                                <div class="drag-image" id="carousel_browse_button">-->
