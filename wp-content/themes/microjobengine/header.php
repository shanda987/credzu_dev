...
<body <?php body_class(); ?>>
	<header id="et-header">
		...
		<?php if( !is_page_template('page-user-authentication.php') && !is_singular('mjob_post') && !is_page_template('page-full-width.php') && !is_page_template('page-full-screen.php') && !is_archive() ): ?>
