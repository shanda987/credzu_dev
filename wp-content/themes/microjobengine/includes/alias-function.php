        ...
        if(!empty($current_user->ID)) {
           ...
           ?>
            ...
            <div class="link-post-services">
                ...
                <?php else: ?>
                    <a class="btn-basic post-listing-error" href="#"><?php _e('Post a Listing', ET_DOMAIN); ?>
                        <div class="plus-circle"><i class="fa fa-plus"></i></div>
                    </a>
                <?php endif; ?>
            </div>
...
//            $sign_up_class = "signup-link focus-signup-form";
            ?>
            <div class="link-account link-account-desktop">
            ...
            <div class="link-account link-account-mobile">
                <ul class="login-list-icon">
                <li><a href="#" class="hireSignup"><?php _e('Login', ET_DOMAIN); ?></a></li>
                </ul>
            </div>
            <?php
        }
