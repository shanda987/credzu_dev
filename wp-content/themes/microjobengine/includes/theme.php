...
//                }
        ...
        if( is_tax('mjob_category') ){
            ...
            if( $term_id != 2 && $queried_object->parent != 2 && $term_id != 58 && $queried_object->parent != 58){
...
?>
    ...
    public function mJobIncludeTemplate(){
        ...
        if( is_page_template('page-post-service.php') || is_singular('mjob_post')){
    ...
    public function mJobGlobals($vars){
        ...
        $vars['is_tax_mjob_category'] = is_tax('mjob_category') && is_post_type_archive('mjob_post');
        ...
        $vars['user_role'] = ae_user_role($user_ID);
        return $vars;
    }
    /**
     * user pending option
