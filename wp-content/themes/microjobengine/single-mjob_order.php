                                            ...
                                            <?php foreach( $terms as $term):
                                                ...
                                                if( $f ):
                                                    if( empty($current->need_uploads) || !in_array( $term->slug, $current->need_uploads )):
                                                        ...
                                                        $com = '   <a data-type="'.$term->check_type.'" data-id="'.$term->slug.'" data-name="'.$term->name.'" href="#" class="resend-requirement-style resend-requirement" title="'.__('unlock', ET_DOMAIN).'"><i class="fa fa-lock" aria-hidden="true"></i></a>';
                                                        $class = 'disabled';
                                                    else:
                                                        $com = '';
